...
def tests():
    ...
    "id": 1,
    "name": f"The Sea Explorer{random.randint(9999999,99999999999999999999999999999999)}",
    "duration": 7,
    "maxGroupSize": 15,
    "difficulty": "medium",
    ...
    data = requests.post("http://127.0.0.1:3000/api/v1/tours",data=data)
    print(data.json())
for i in range(1):
    threading.Thread(target=tests).start()